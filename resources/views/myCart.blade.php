            ...
            <tbody>
               ...
               <tr>
                  <td>
                     ...
                     <input type="hidden" name="subtotal[]" id="subtotal[]" value="{{$product-> price}}">
      ...
      <div class="col-md-6 col-md-offset-3">
         <div class="panel panel-default credit-card-box">
            ...
            <div class="panel-body">
               ...
               <div class='form-row row'>
                  <div class='col-xs-12 col-md-4 aform-group cvc required'>
...
<script type="text/javascript">
        $(function() {
            ...
            var stripeKey =
                'pk_test_51OKZymK9fpKmv0uXdSQ77t6ify1xvLfxFHkG7rq21a0B60h9nQ2nfVwAduXhe1jU9HhXykJcEagBQQfVu4Rxmz0J00qQzvNfPq';
